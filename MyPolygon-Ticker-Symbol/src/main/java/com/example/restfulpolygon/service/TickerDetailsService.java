...
public class TickerDetailsService {
    ...
    public TickerDetailsEntity getTickerNews(String ticker) {
        String url = "https://api.polygon.io/v2/reference/news?ticker=" + ticker + "&apiKey=" + apiKey;
        ResponseEntity<String> response = restTemplate.getForEntity(url, String.class);
        printPrettyJSON(response.getBody());
        
        //System.out.println("Ticker News: " + response.getBody());
    ...
    private void printPrettyJSON(String uglyJSON) {
